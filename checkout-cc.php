...
?>
	...
	<div class="container">
        ...
        <div class="col-sm-12">		
           <div class="row">
           		<div>
                	<div class="col-sm-4 fr">Establish an account based on this PO and speed up delivery of yourproduct!
               		</div>
                    <div class="newClear"></div>
                </div>
                <div class="padsim4">
                ...
                <div class="grey-box3">
                             ...
                             <div class="padsim2">
                                ...
                                <span class="moresapce">$4.99</span><span>21</span>
                                <div class="newClear"></div>
                                </div>
                                </div>                        
                                <div class="newClear"></div>
                             ...
                             <div>
                             <div class="col-sm-6">
								NOTICE:Quotes are good for <strong>30days</strong> after which the quote number will expire.If you need to adjustorre printyour quote,you may view create a quote from your<strong> purchase history</strong>. Call us at 1-800-999-9999 with questions orcomments.
        					 </div>
                             <div class="col-sm-3 fr">
                                <div class="totalBox2">
                                    <div class="totlaBar">
                                        <strong>SubTotal:</strong><span>$544.99</span>
                                    </div>
                                    <div class="totlaBar">
                                        <strong>Shipping:</strong><span>$16.99</span>
                                    </div>
                                    <div class="totlaBar">
                                        <strong>Tax</strong><span>$0.00</span>
                                    </div>
                                    <div class="totlaBar2">
                                        <strong>Total</strong><span>$561.98</span>
                                    </div>
                                </div>
        					  </div>
        					 </div>

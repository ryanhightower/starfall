...
get_header_product(); ?>
		...
		<div class="clearfix"></div>
            ...
            <p class="book_left_price"><b>$6.95</b> <span>$4.95</span><br /><a href="#">Add to cart</a></p>
			</div>
			<div class="clearfix"></div>
		...
		<section class="container pro-list2 nobod">			
            ...
            <div class="col-md-3">
            <h3 class="bookTtile">Backpack Bear's Invertebrates Book</h3>
            <img data-src="holder.js/100x100" alt="100x100" class="img-circle img-responsive"><br>
			<span class="priceRed">$4.99</span>
            <a href="#">Add to cart</a>
		...
		<section class="container pro-list2 nobod">			
			<h2 align="left">"Read to Me" Books</h2>
            <p class="simplealignleft">"Read to Me" books are meant to be read aloud to your students in the classroom. They include various topics from fiction to non fiction.</p>
            <div class="col-md-3">
            <h3 class="bookTtile">Backpackx Bear's Mammal Book</h3>
            <img data-src="holder.js/100x100" alt="100x100" class="img-circle img-responsive"><br>
			<span class="priceRed">$4.95</span>
		...
		<section class="container pro-list2 nobod">			
			<h2 align="left">"Learn to Read" Books</h2>
            <p class="simplealignleft">"Learn to Read" books are beginners books meant to be read by yourstudents. They will learn to recognize common words and phrases.</p>
            <div class="col-md-3">
            <h3 class="bookTtile">Boxed Set of Learn to ReadBooks</h3>
            <img data-src="holder.js/100x100" alt="100x100" class="img-circle img-responsive"><br>
			<div class="priceblack"><span class="one">$23.50</span><span class="two">$19.95</span></div>
            <a href="#">Add to cart</a>
            ...
            <div class="col-md-3">
            <h3 class="bookTtile">Boxed Set of Short-Vowel Palsl</h3>
            <img data-src="holder.js/100x100" alt="100x100" class="img-circle img-responsive"><br>
			<div class="priceblack"><span class="one">$23.50</span><span class="two">$19.95</span></div>
            <a href="#">Add to cart</a>
            ...
            <div class="col-md-3">
            <h3 class="bookTtile">Set of Backpack Bear's Books</h3>
            <img data-src="holder.js/100x100" alt="100x100" class="img-circle img-responsive"><br>
			<div class="priceblack"><span class="one">$23.50</span><span class="two">$19.95</span></div>
            <a href="#">Add to cart</a>

                 ...
                 <div class="row">
                    <div class="grey-box2">
                     <div class="padsim1">
                       ...
                       <span> A typical classroom will have one of these per student. Tip:you may want to order a few extras for replacements and new student transfers.
						</span></div></div>
...
<?php } }?>
        	...
        	<div class="totalBox">
            	<div class="totlaBar">
                	<strong>SubTotal: </strong><span id="subtotal">$<?php echo $_SESSION['curriculum']['subtotal']; ?></span>
                </div>
                <!--<div class="totlaBar">
...
var total = 0;	
	...
	$('#p_price_'+product_id).html('$'+data);
		...
		$('#total').html(total);*/
		var total = 0;
		var subtotal = '<?php echo $_SESSION['curriculum']['subtotal']; ?>';
		$('.grey-box2 input[type=text]').each(function(index, element) {
		var id = $(this).attr("id");
		var id_arr = id.split('_');
		var product_id = id_arr[1];

...
to order a few extras for replacements and new student transfers.
                     ...
                     <div class="padsim1">
                        ...
                        <div class="col-sm-3"><span>$4.99&nbsp;</span><input type="text" name="textfield" id="textfield" value="<?php echo $total_students; ?>"></div>                        
                        <div class="newClear"></div>
                     </div> 
                     <div class="padsim1">
                     	<div class="col-sm-9">
                ...
                <div class="col-sm-3 fr">        	
            		<!-- <div class="padsim3"><a class="btn btn-primary btn-lg" href="">Add All to Cart</a></div> -->
           			<div class="padsim3"><a class="btn btn-primary btn-lg" href="<?php echo SITE_URL;?>/cart.php ">Add All to Quote</a></div>
        		</div>   
				</div>
